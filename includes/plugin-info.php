...
<div class="postbox">
    ...
    <h3 class="hndle"><?php _e('Donate, if you like this plugin', 'tags-all-in-one') ?></h3>
    <div class="inside">
        <p><?php _e('Thanks for all donations, no matter the size.', 'tags-all-in-one') ?></p>
    ...
    <h3 class="hndle" style="border-top: 1px solid #eee;">
        <span><?php _e('Need support?', 'tags-all-in-one') ?></span>
    </h3>
    <div class="inside">
        <p class="inner">
            ...
            <?php _e('For more information about this plugin, please visit', 'tags-all-in-one') ?> <a href="http://www.teastudio.pl/en/product/tags-all-in-one/" target="_blank" title="http://www.teastudio.pl/en/product/tags-all-in-one/"><?php _e('plugin page', 'tags-all-in-one') ?></a><br />
        </p>
    </div>

    <h3 class="hndle" style="color:#A6CF38;border-top: 1px solid #eee;">
        <span><?php _e('Need custom modification, plugin or theme?', 'tags-all-in-one') ?></span>
    </h3>
    <div class="inside">
        <p class="inner">
            <?php _e('If you like this plugin, but need something a bit more custom or completely new, you can hire me to work for you! Email me at <a href="mailto:m.gierada@teastudio.pl" title="Hire me">m.gierada@teastudio.pl</a> for more information!', 'tags-all-in-one') ?><br />
        </p>
    </div>
