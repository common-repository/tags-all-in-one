...
Plugin URI: http://www.teastudio.pl/en/product/tags-all-in-one/
...
class Tags_All_In_One {
	...
	public function __construct() {
        ...
        if ( is_admin() ) {
            ...
            */
             ...
             */
            add_action( "admin_enqueue_scripts", array($this, "admin_tags_all_in_one_register_scripts") );
            /*
     ...
     */
    public function admin_tags_all_in_one_register_scripts() {
        wp_register_script("tags-all-in-one-js", plugin_dir_url(__FILE__) . "js/tags-all-in-one.js", array('jquery'), '1.0.0', true);
        wp_enqueue_script("tags-all-in-one-js");

        wp_register_style("tags-all-in-one-css", plugin_dir_url(__FILE__) . "css/tags-all-in-one.css");
        wp_enqueue_style("tags-all-in-one-css");
    }
